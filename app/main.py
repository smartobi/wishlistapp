...
#https://www.youtube.com/watch?v=En_4k8umjb4&list=PLFhNzVKP1pVo1sSlVg4GxJTvO1-Eu6Yzh&index=7
...
app.config['SQLALCHEMY_DATABASE_URI'] =  f'postgresql://{POSTGRES_USER}:{PGPASSWORD}@{POSTGRES_HOST}:{POSTGRES_PORT}/{POSTGRES_DB}'
